        ...
        <>
            <div class="grid grid-cols-2 grid-rows-1 grid-flow-col w-full h-[600px] mb-[50px]" style={{ backgroundColor: '#211C24'}}>
                <div>
                    ...
                    <button className="w-[200px] h-[50px] bg-white ml-[250px] mt-[25px] text-black font-normal text-center rounded border border-black border-[1px]">Mua sắm nào!!</button>
                </div>
                <div class="">
